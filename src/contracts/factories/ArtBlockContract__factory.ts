...
import { ArtBlockContract } from "../ArtBlockContract";

export class ArtBlockContract__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ArtBlockContract {
    return new Contract(address, _abi, signerOrProvider) as ArtBlockContract;
  }
}
