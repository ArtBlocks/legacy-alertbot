...
import type { V2ArtBlockContract } from "../V2ArtBlockContract";

export class V2ArtBlockContract__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): V2ArtBlockContract {
    return new Contract(address, _abi, signerOrProvider) as V2ArtBlockContract;
  }
}
